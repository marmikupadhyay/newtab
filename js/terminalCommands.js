...
sites = localStorage.getItem("shorthand") ? JSON.parse(localStorage.getItem("shorthand")) : sites;

let favBgs = {
  gojo:"https://images.wallpapersden.com/image/download/jujutsu-kaisen-satoru-gojo_bGtubmuUmZqaraWkpJRmbmdlrWZlbWU.jpg",
};
favBgs = localStorage.getItem("favBgs") ? JSON.parse(localStorage.getItem("favBgs")) : favBgs;
...
currTheme = localStorage.getItem("currTheme") ? JSON.parse(localStorage.getItem("currTheme")) : currTheme;
...
savedThemes = localStorage.getItem("themes") ? JSON.parse(localStorage.getItem("themes")) : savedThemes;
